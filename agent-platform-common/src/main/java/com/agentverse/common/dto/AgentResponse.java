...
public class AgentResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (this$sessionBackend == null ? other$sessionBackend != null : !this$sessionBackend.equals(other$sessionBackend)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AgentResponse;
    }
