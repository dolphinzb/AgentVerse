...
public class AgentUpdateRequest {
    ...
    private @Size(max=100, message="Agent \u540d\u79f0\u957f\u5ea6\u4e0d\u80fd\u8d85\u8fc7 100 \u4e2a\u5b57\u7b26") String name;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentUpdateRequest)) {
            return false;
        }
        AgentUpdateRequest other = (AgentUpdateRequest)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AgentUpdateRequest;
    }
    ...
    public String toString() {
        return "AgentUpdateRequest(name=" + this.getName() + ", description=" + this.getDescription() + ", sysPrompt=" + this.getSysPrompt() + ", maxIterations=" + this.getMaxIterations() + ", workspaceMode=" + this.getWorkspaceMode() + ", modelConfigId=" + this.getModelConfigId() + ", filesystemType=" + this.getFilesystemType() + ", enableMemoryFlush=" + this.getEnableMemoryFlush() + ", enableMemoryMaintenance=" + this.getEnableMemoryMaintenance() + ", enableCompaction=" + this.getEnableCompaction() + ", compactionTriggerPct=" + this.getCompactionTriggerPct() + ", compactionKeepRecent=" + this.getCompactionKeepRecent() + ", enableToolResultEviction=" + this.getEnableToolResultEviction() + ", toolResultEvictionMaxChars=" + this.getToolResultEvictionMaxChars() + ", enableLongTermMemory=" + this.getEnableLongTermMemory() + ", enablePlan=" + this.getEnablePlan() + ", enableSessionPersistence=" + this.getEnableSessionPersistence() + ", sessionBackend=" + this.getSessionBackend() + ", maxContextTokens=" + this.getMaxContextTokens() + ")";
    }
}
